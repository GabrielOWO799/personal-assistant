...
"""
AI玩具搜集脚本 - 周五18:00执行
搜索关键词：AI玩具、AI陪伴机器人、智能玩具、AI教育玩具
"""
...
def search_ai_toys(history):
    """AI玩具搜索"""
    queries = [
        "AI玩具 儿童 教育 2026",
        "AI陪伴机器人 众筹 Kickstarter",
        "智能玩具 语音交互 新品",
        "AI早教玩具 上市",
        "情感陪伴 AI玩具",
        "AI机器人 儿童 陪伴",
...
def main():
    ...
    print("\n[AI玩具] 搜索AI玩具新品...")
    results = search_ai_toys(history)
    ...
    output_file = f"{SEARCH_BUFFER_DIR}/ai_toys_{today}.json"
